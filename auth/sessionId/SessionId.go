...
// SignSessionID calcule la signature HMAC d'un ID et renvoie "ID:Signature"
...
// ValidateSignedSessionID vérifie la signature du session_id
func ValidateSignedSessionID(signedValue string) (string, error) {
